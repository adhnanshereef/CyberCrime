...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are an expert financial investigator. 
Extract the following details from this transaction screenshot or SMS message. 
Output STRICTLY in the following JSON schema:
{
  "utr_transaction_id": "string or null",
  "bank_or_app_name": "string or null",
